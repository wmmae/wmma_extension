...
__global__ void test_elementwise_kernel(float *const ptr) {
  ...
  mtk::wmma::tcec::store_matrix_sync(smem, frag, N,
...
template <unsigned N, class T, class Policy> void test_elementwise() {
...
int main() {
  ...
  test_elementwise<
      32, half,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::with_ec, mtk::wmma::tcec::op_mma>::type>();
  test_elementwise<
      32, half,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::without_ec, mtk::wmma::tcec::op_mma>::type>();
  test_elementwise<32, float,
                   typename mtk::wmma::tcec::detail::default_policy<
