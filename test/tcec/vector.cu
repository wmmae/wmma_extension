...
__global__ void load_vector_ab_test_kernel(const float *const cor_ptr,
...
__global__ void
load_vector_acc_test_kernel(const float *const cor_ptr,
                            const float *const src_ptr,
                            const nvcuda::wmma::layout_t layout) {
  mtk::wmma::tcec::fragment<nvcuda::wmma::accumulator, m, n, k, T, void, Policy>
      frag, frag_c;
  mtk::wmma::tcec::fill_fragment(frag, 0.0f);
...
struct test_switch {
  void operator()(float *const mat_mem, float *const vec_mem) {
    load_vector_ab_test_kernel<Use, m, n, k, T, Layout, Policy>
        <<<1, mtk::test_utils::warp_size>>>(mat_mem, vec_mem);
  }
};
...
struct test_switch<nvcuda::wmma::accumulator, m, n, k, T, Layout, Policy> {
  void operator()(float *const mat_mem, float *const vec_mem) {
    const auto layout = (std::is_same<nvcuda::wmma::col_major, Layout>::value)
                            ? nvcuda::wmma::mem_col_major
                            : nvcuda::wmma::mem_row_major;
    load_vector_acc_test_kernel<m, n, k, T, Policy>
        <<<1, mtk::test_utils::warp_size>>>(mat_mem, vec_mem, layout);
  }
};
...
void load_vector_test() {
  ...
  std::printf("Policy : Policy<%7s,%9s,%2u,%2u,%2u>\n",
              ...
              std::is_same<typename Policy::error_correction,
                  ...
                  ? "{w/ ec}"
                  : "{w/o ec}",
              Policy::m, Policy::n, Policy::k);
  constexpr unsigned mem_m =
      mtk::wmma::tcec::detail::select_value<Use, m, k, m>::value;
  constexpr unsigned mem_n =
      mtk::wmma::tcec::detail::select_value<Use, k, n, n>::value;

  constexpr auto vec_len =
      std::is_same<Layout, nvcuda::wmma::col_major>::value ? mem_m : mem_n;
...
template <int m, int n, int k, class T, class Policy>
__global__ void
store_vector_acc_test_kernel(float *const dst_ptr, const float *const src_ptr,
                             const nvcuda::wmma::layout_t layout) {
  mtk::wmma::tcec::fragment<nvcuda::wmma::accumulator, m, n, k, T, void, Policy>
      frag;
...
void store_vector_test() {
  ...
  const auto layout = (std::is_same<nvcuda::wmma::col_major, Layout>::value)
                          ? nvcuda::wmma::mem_col_major
                          : nvcuda::wmma::mem_row_major;
  store_vector_acc_test_kernel<m, n, k, T, Policy>
      <<<1, mtk::test_utils::warp_size>>>(mat_mem, mat_mem, layout);
...
int main() {
  load_vector_test<
      nvcuda::wmma::matrix_a, 32, 32, 32, half, nvcuda::wmma::col_major,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::with_ec, mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::matrix_b, 32, 32, 32, half, nvcuda::wmma::col_major,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::with_ec, mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::accumulator, 32, 32, 32, half, nvcuda::wmma::col_major,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::with_ec, mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::matrix_a, 32, 32, 32, half, nvcuda::wmma::row_major,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::with_ec, mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::matrix_b, 32, 32, 32, half, nvcuda::wmma::row_major,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::with_ec, mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::accumulator, 32, 32, 32, half, nvcuda::wmma::row_major,
      typename mtk::wmma::tcec::detail::default_policy<
          half, mtk::wmma::tcec::with_ec, mtk::wmma::tcec::op_wmma>::type>();
  store_vector_test<
      nvcuda::wmma::accumulator, 32, 32, 32, half, nvcuda::wmma::col_major,
...
#ifdef TEST_SIMT
  load_vector_test<nvcuda::wmma::matrix_a, 32, 32, 32, float,
                   nvcuda::wmma::col_major,
                   typename mtk::wmma::tcec::detail::default_policy<
                       float, mtk::wmma::tcec::without_ec,
                       mtk::wmma::tcec::op_simt>::type>();
  load_vector_test<nvcuda::wmma::matrix_b, 32, 32, 32, float,
                   nvcuda::wmma::col_major,
                   typename mtk::wmma::tcec::detail::default_policy<
                       float, mtk::wmma::tcec::without_ec,
                       mtk::wmma::tcec::op_simt>::type>();
  load_vector_test<nvcuda::wmma::accumulator, 32, 32, 32, float,
                   nvcuda::wmma::col_major,
                   typename mtk::wmma::tcec::detail::default_policy<
                       float, mtk::wmma::tcec::without_ec,
                       mtk::wmma::tcec::op_simt>::type>();
  ...
  load_vector_test<nvcuda::wmma::accumulator, 32, 32, 32, float,
                   ...
                   typename mtk::wmma::tcec::detail::default_policy<
                       float, mtk::wmma::tcec::without_ec,
                       mtk::wmma::tcec::op_simt>::type>();
  store_vector_test<nvcuda::wmma::accumulator, 32, 32, 32, float,
                    nvcuda::wmma::col_major,
                    typename mtk::wmma::tcec::detail::default_policy<
                        float, mtk::wmma::tcec::without_ec,
                        mtk::wmma::tcec::op_simt>::type>();
...
#ifdef TEST_TF32
  load_vector_test<nvcuda::wmma::matrix_a, 32, 32, 32,
                   nvcuda::wmma::precision::tf32, nvcuda::wmma::col_major,
                   typename mtk::wmma::tcec::detail::default_policy<
                       nvcuda::wmma::precision::tf32, mtk::wmma::tcec::with_ec,
                       mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<nvcuda::wmma::matrix_b, 32, 32, 32,
                   nvcuda::wmma::precision::tf32, nvcuda::wmma::col_major,
                   typename mtk::wmma::tcec::detail::default_policy<
                       nvcuda::wmma::precision::tf32, mtk::wmma::tcec::with_ec,
                       mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<nvcuda::wmma::accumulator, 32, 32, 32,
                   nvcuda::wmma::precision::tf32, nvcuda::wmma::col_major,
                   typename mtk::wmma::tcec::detail::default_policy<
                       nvcuda::wmma::precision::tf32, mtk::wmma::tcec::with_ec,
                       mtk::wmma::tcec::op_wmma>::type>();
  ...
  load_vector_test<nvcuda::wmma::accumulator, 32, 32, 32,
                   ...
                   typename mtk::wmma::tcec::detail::default_policy<
                       nvcuda::wmma::precision::tf32, mtk::wmma::tcec::with_ec,
                       mtk::wmma::tcec::op_wmma>::type>();
  store_vector_test<nvcuda::wmma::accumulator, 32, 32, 32,
                    nvcuda::wmma::precision::tf32, nvcuda::wmma::col_major,
                    typename mtk::wmma::tcec::detail::default_policy<
                        nvcuda::wmma::precision::tf32, mtk::wmma::tcec::with_ec,
                        mtk::wmma::tcec::op_wmma>::type>();
  store_vector_test<nvcuda::wmma::accumulator, 32, 32, 32,
                    ...
                    typename mtk::wmma::tcec::detail::default_policy<
                        ...
                        mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::matrix_a, 32, 32, 32, nvcuda::wmma::precision::tf32,
      nvcuda::wmma::col_major,
      typename mtk::wmma::tcec::detail::default_policy<
          nvcuda::wmma::precision::tf32, mtk::wmma::tcec::without_ec,
          mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::matrix_b, 32, 32, 32, nvcuda::wmma::precision::tf32,
      nvcuda::wmma::col_major,
      typename mtk::wmma::tcec::detail::default_policy<
          nvcuda::wmma::precision::tf32, mtk::wmma::tcec::without_ec,
          mtk::wmma::tcec::op_wmma>::type>();
  load_vector_test<
      nvcuda::wmma::accumulator, 32, 32, 32, nvcuda::wmma::precision::tf32,
      nvcuda::wmma::col_major,
      typename mtk::wmma::tcec::detail::default_policy<
          nvcuda::wmma::precision::tf32, mtk::wmma::tcec::without_ec,
          mtk::wmma::tcec::op_wmma>::type>();
