...
template <class T> std::string get_string();
...
template <> std::string get_string<nvcuda::wmma::precision::tf32>() {
  return "tf32";
}
template <> std::string get_string<nvcuda::wmma::col_major>() {
  return "col_major";
}
template <> std::string get_string<nvcuda::wmma::row_major>() {
  return "row_major";
}
template <> std::string get_string<void>() { return "void"; }
template <> std::string get_string<nvcuda::wmma::matrix_a>() {
  return "matrix_a";
}
template <> std::string get_string<nvcuda::wmma::matrix_b>() {
  return "matrix_b";
}
template <> std::string get_string<nvcuda::wmma::accumulator>() {
  return "accumulator";
}

template <class T> double get_machine_eps();
template <> double get_machine_eps<half>() { return 1. / (1 << 10); }
template <> double get_machine_eps<nvcuda::wmma::precision::tf32>() {
  return 1. / (1 << 10);
}
template <> double get_machine_eps<float>() { return 1. / (1 << 23); }
template <> double get_machine_eps<std::int32_t>() {
  return get_machine_eps<float>();
}
template <> double get_machine_eps<std::int8_t>() {
  return get_machine_eps<float>();
}
template <> double get_machine_eps<std::uint8_t>() {
  return get_machine_eps<float>();
}
...
double get_max_relative_error(
    ...
    const C_T *const c, const D_T *const d) {
  double max_base = 0.0;
  double max_diff = 0.0;
