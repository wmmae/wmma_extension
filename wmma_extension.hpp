...
// For sm80
template <class T>
__device__ inline void load_vector_sync_sm80(nvcuda::wmma::fragment<nvcuda::wmma::matrix_a, 16, 16, 16, half, nvcuda::wmma::col_major>& frag, const T* const ptr, const bool fill) {
	if (fill)
...
template <class T>
__device__ inline void load_vector_sync_sm80(nvcuda::wmma::fragment<nvcuda::wmma::matrix_a, 16, 16, 16, half, nvcuda::wmma::row_major>& frag, const T* const ptr, const bool fill) {
	if (fill)
		nvcuda::wmma::fill_fragment(frag, __float2half(0.0f));
	const unsigned warp_id = threadIdx.x & 0x1f;
	// TODO : 36-a100
...
template <class T>
__device__ inline void load_vector_sync_sm80(nvcuda::wmma::fragment<nvcuda::wmma::matrix_b, 16, 16, 16, half, nvcuda::wmma::col_major>& frag, const T* const ptr, const bool fill) {
	if (fill)
		nvcuda::wmma::fill_fragment(frag, __float2half(0.0f));
	const unsigned warp_id = threadIdx.x & 0x1f;
	// TODO : 36-a100
...
template <class T>
__device__ inline void load_vector_sync_sm80(nvcuda::wmma::fragment<nvcuda::wmma::matrix_b, 16, 16, 16, half, nvcuda::wmma::row_major>& frag, const T* const ptr, const bool fill) {
	if (fill)
		nvcuda::wmma::fill_fragment(frag, __float2half(0.0f));
	const unsigned warp_id = threadIdx.x & 0x1f;
	// TODO : 36-a100
