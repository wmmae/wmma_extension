...
template <
    class Use, int m, int n, int k, class T, class Layout, class Op, int fm,
    int fn, int fk,
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                             std::is_same<Op, mtk::wmma::tcec::op_wmma>::value),
                            bool>::type = false>
__device__ fragment<
    Use, m, n, k, T, Layout,
    mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec, fm, fn, fk>>
neg(const fragment<Use, m, n, k, T, Layout,
                   mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec, fm,
                                           fn, fk>> &frag) {
...
__device__ void fill_fragment(
    fragment<Use, m, n, k, T, Layout,
             mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec, fm, fn,
                                     fk>> &frag,
...
template <
    ...
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                            ...
                            bool>::type = false>
__device__ void
fill_zero(fragment<Use, m, n, k, T, Layout,
                   mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec, fm,
                                           fn, fk>> &frag) {
  using sub_frag_t = typename mtk::wmma::tcec::detail::sub_frag_t<Use, T>::type;
  using Policy =
...
// Load matrix
template <
    class MatrixLayout, int m, int n, int k, class T, class Op, int fm, int fn,
    int fk, class MEM_T,
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                             std::is_same<Op, mtk::wmma::tcec::op_wmma>::value),
                            bool>::type = false>
...
template <
    int m, int n, int k, class T, class Op, int fm, int fn, int fk, class MEM_T,
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                             std::is_same<Op, mtk::wmma::tcec::op_wmma>::value),
                            bool>::type = false>
__device__ void load_matrix_sync(
...
template <
    class MatrixLayout, class Use, int m, int n, int k, class T, class Layout,
    class Op, int fm, int fn, int fk, class MEM_T,
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                             std::is_same<Op, mtk::wmma::tcec::op_wmma>::value),
                            bool>::type = false>
__device__ void load_matrix_sync(
...
__device__ void store_matrix_sync(
    float *const ptr,
    fragment<
        nvcuda::wmma::accumulator, m, n, k, T, void,
        mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec, fm, fn, fk>>
        frag,
...
template <
    ...
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                            ...
                            bool>::type = false>
__device__ void
load_vector(fragment<nvcuda::wmma::accumulator, m, n, k, T, void,
...
template <
    ...
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                            ...
                            bool>::type = false>
__device__ void
load_vector(fragment<Use, m, n, k, T, Layout,
                     mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec,
                                             fm, fn, fk>> &frag,
...
store_vector(MEM_T *const ptr,
             fragment<nvcuda::wmma::accumulator, m, n, k, T, void,
                      mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec,
                                              fm, fn, fk>> &frag,
             const float mul, const nvcuda::wmma::layout_t layout) {
  using Policy =
      mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec, fm, fn, fk>;
  constexpr auto frag_m = mtk::wmma::tcec::detail::select_value<
      nvcuda::wmma::accumulator, Policy::m, Policy::k, Policy::m>::value;
...
// mma_rz
template <
    int m, int n, int k, class A_Layout, class B_Layout, class T, class Op,
    int fm, int fn, int fk,
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                             std::is_same<Op, mtk::wmma::tcec::op_wmma>::value),
                            bool>::type = false>
...
template <
    ...
    typename std::enable_if<(std::is_same<Op, mtk::wmma::tcec::op_mma>::value ||
                            ...
                            bool>::type = false>
__device__ void
mma_sync(fragment<nvcuda::wmma::accumulator, m, n, k, T, void,
                  mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec, fm,
                                          fn, fk>> &frag_d,
         const fragment<nvcuda::wmma::matrix_a, m, n, k, T, A_Layout,
                        mtk::wmma::tcec::Policy<Op, mtk::wmma::tcec::without_ec,
