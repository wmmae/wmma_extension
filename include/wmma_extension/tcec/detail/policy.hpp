...
// ===================================
template <class T, class ErrorCorrection = mtk::wmma::tcec::with_ec,
          class Op = mtk::wmma::tcec::op_wmma,
          class Sm = mtk::wmma::tcec::sm_auto>
struct default_policy;

template <class ErrorCorrection, class Sm>
struct default_policy<half, ErrorCorrection, mtk::wmma::tcec::op_wmma, Sm> {
  using type = mtk::wmma::tcec::Policy<mtk::wmma::tcec::op_wmma,
                                       ErrorCorrection, 16, 16, 16>;
};

template <class ErrorCorrection, class Sm>
struct default_policy<nvcuda::wmma::precision::tf32, ErrorCorrection,
                      mtk::wmma::tcec::op_wmma, Sm> {
  using type = mtk::wmma::tcec::Policy<mtk::wmma::tcec::op_wmma,
                                       ErrorCorrection, 16, 16, 8>;
};

template <class ErrorCorrection, class Sm>
struct default_policy<half, ErrorCorrection, mtk::wmma::tcec::op_mma, Sm> {
  using type = mtk::wmma::tcec::Policy<mtk::wmma::tcec::op_mma, ErrorCorrection,
                                       16, 8, 16>;
};

template <class ErrorCorrection>
struct default_policy<half, ErrorCorrection, mtk::wmma::tcec::op_mma,
                      mtk::wmma::tcec::sm_75> {
  using type = mtk::wmma::tcec::Policy<mtk::wmma::tcec::op_mma, ErrorCorrection,
                                       16, 8, 8>;
};
...
template <class Use, class T, class Layout, class ErrorCorrection, int fm,
          int fn, int fk>
struct default_fragment<Use, T, Layout,
                        Policy<op_wmma, ErrorCorrection, fm, fn, fk>> {
...
template <class Use, class T, class Layout, class ErrorCorrection, int fm,
          int fn, int fk>
struct default_fragment<Use, T, Layout,
                        Policy<op_mma, ErrorCorrection, fm, fn, fk>> {
